...
namespace Facturacion.Models
{
    ...
    public class Configuracion
    {
        ...
        [Required]
        [DefaultValue(false)]
        public bool VerObrasTerminadas { get; set; }

        /// <summary>
        /// Permitir ver las Facturas ya terminadas
        /// </summary>
        [Required]
        [DefaultValue(false)]
        public bool VerFacturasTerminadas { get; set; }
        ...
        [Column(TypeName = "varchar")]
        [StringLength(8000)]
        public string PiePaginaFacturas { get; set; }
